...
Shader"Dynamic Ground System/No Tesselation/Basic" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma only_renderers d3d9 d3d11 glcore gles xboxone ps4 psp2 n3ds wiiu 
            #pragma target 3.0
            ...
            ////// Specular:
                ...
                float3 diffuseColor = lerp(_LowerLayer.rgb, (_MainTex_var.rgb * _BaseColor.rgb), _GroundMap_var.rgb); // Need this for specular when using metallic
